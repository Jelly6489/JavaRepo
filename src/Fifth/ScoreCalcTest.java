    ...
    public String toString() {
        return "Bachelor{" +
                ...
                ", standard deviation=" + MyMathLib.calcStdDev(
                        MyMathLib.calcVariation(scores, MyMathLib.calcMean(scores))) +
                '}';
    }
}
...
class Master extends Bachelor {
    ...
    public String toString() {
        return "Master{" +
                ...
                ", paper='" + paper + '\'' +
                ", Master scores=" + Arrays.toString(getScores()) +
                ", mean=" + MyMathLib.calcMean(getScores()) +
                ", variation=" + MyMathLib.calcVariation(
                getScores(), MyMathLib.calcMean(getScores())) +
                ", standard deviation=" + MyMathLib.calcStdDev(
                MyMathLib.calcVariation(getScores(), MyMathLib.calcMean(getScores()))) +
                '}';
...
숙제
    ...
    이 지저분한 부분을 어떻게 깔끔하게 바꿀 수 있을지 고찰해도록 한다.
*/
