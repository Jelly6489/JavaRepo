...
public class HashSetTest {
    public static void main(String[] args) {
        ...
        for (Integer value: arr){
            ...
            // 중복이 아니라면 1을 리턴하게 된다.
            // 즉 중복된 녀석이 출력이 되고
            // 중복이 아닌 경우엔 출력이 되자 않는다.
            if(!s.add(value)) {
                System.out.println(cnt + "루트 반복된 녀석: " + value);
            }
        }
...
// 0. 복습(눈으로만 보는거 x, 코드 쳐봐야 실력이 늘어요)
// 1. ArrayList를 가지고 랜덤한 값을 10개 입력 받고
//    입력 받은 값을 랜덤한 조합으로 더해서 합친 결과를 다시 ArrayList에 저장해보자.
